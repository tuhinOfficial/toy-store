    ...
    <div className="mt-16">
      <section className="banner">
        <div className="md:flex justify-evenly items-center">
          <div className="md:w-[50%]">
            <h1 className="text-3xl md:text-5xl font-semibold leading-normal text-[#0C134F]">
      ...
      <section className="my-20">
        <div className="client">
          <div className="flex flex-col md:flex-row gap-y-10 md:gap-y-0 justify-evenly py-20 text-white font-bold text-center">
            <div>
      ...
      <section className="review my-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-8 md:ml-16 overflow-x-hidden">
          ...
          <div data-aos="fade-left" data-aos-duration="1000" data-aos-offset="100" className="card w-72 mx-auto md:w-96 bg-primary text-primary-content text-center">
            <div className="card-body">
              <div className="avatar">
                <div className="w-14 rounded-full mx-auto">
                  <img src="https://i.ibb.co/VwYLp3b/cheerful-curly-business-girl-wearing-glasses.jpg" />
          ...
          <div data-aos="zoom-in-right" data-aos-duration="1000" data-aos-offset="100" className="card w-72 mx-auto md:w-96 bg-primary text-primary-content text-center">
            <div className="card-body">
              <div className="avatar">
                <div className="w-14 rounded-full mx-auto">
                  <img src="https://i.ibb.co/VwYLp3b/cheerful-curly-business-girl-wearing-glasses.jpg" />
          ...
          <div data-aos="zoom-in-left" data-aos-duration="1000" data-aos-offset="100" className="card w-72 mx-auto md:w-96 bg-primary text-primary-content text-center">
            <div className="card-body">
              <div className="avatar">
                <div className="w-14 rounded-full mx-auto">
                  <img src="https://i.ibb.co/VwYLp3b/cheerful-curly-business-girl-wearing-glasses.jpg" />
